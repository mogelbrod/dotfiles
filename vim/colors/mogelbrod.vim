...
" Search
hi Search			ctermfg=Black	ctermbg=Brown	cterm=none		guifg=#141414	guibg=#ffcd64	gui=none
hi IncSearch		ctermfg=Black	ctermbg=Brown	cterm=none		guifg=#141414	guibg=#ffcd64	gui=none
hi MatchParen		ctermfg=White	ctermbg=Cyan	cterm=bold		guifg=#ffffff	guibg=#3cb9e6	gui=none
...
" Identifiers
hi Identifier		ctermfg=Red		ctermbg=none	cterm=none		guifg=#f05a5a	gui=none
hi Function			ctermfg=Red		ctermbg=none	cterm=none		guifg=#f05a5a	gui=none

" Statements
hi Statement		ctermfg=Brown	ctermbg=none	cterm=none		guifg=#ffcd64	gui=none
"hi Conditional		
"hi Repeat			
"hi Label			
"hi Operator		
...
" Other stuff
hi Error			ctermfg=White	ctermbg=Red		cterm=none		guifg=#000000	guibg=#f05a5a	gui=none
